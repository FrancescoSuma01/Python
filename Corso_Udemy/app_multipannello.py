...
class App(tk.Tk):
    def __init__(self):
        super().__init__() #costruttore della classe tk
        self.title("App multi pannello")
        self.geometry("300x200")

        self.container = tk.Frame(self) #contenitore dei pannelli
    ...
    def show_frame(self, idx):
        if idx == 0:
            self.page1.tkraise() #tkraise = porta il frame al primo livello
        elif idx == 1:
            self.page2.tkraise()
