...
class App(tk.Tk):
    def __init__(self):
        ...
        splash = Splash(self)  #questa fa aprire la finestra
        time.sleep(2)  #da due secondi di pausa in attesa che si apre la pagina principale
        splash.destroy()  #distrugge la finestra splash
        self.deiconify()
        ...
        #posto su cui posso colare liberamente(canvas->tela)
        self.canva = tk.Canvas(self, bg='white')
        self.canva.grid(row=1, column=0, sticky='nsew')

        #quando mi muovo con il tasto sinistro cliccato lascio un segno(disegno)
...
class Splash(tk.Toplevel):
    def __init__(self, parent):
        ...
        img = tk.PhotoImage(file="splash.png")  #carica l'immagine solo PNG
